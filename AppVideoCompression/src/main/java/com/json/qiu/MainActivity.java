...
import com.json.qiu.videocompression.MediaController;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_VIDEO_CAPTURE && resultCode == RESULT_OK) {
            Uri videoUri = data.getData();
                ...
                Cursor cursor = getContentResolver().query(videoUri, proj, null,
                        null, null);
    ...
    private class VideoCompressor extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean compressed) {
            ...
            if (compressed) {
                ...
                Log.e("Compressed File Path", "Compressed File Path = " + MediaController.cachedFile.getPath());
